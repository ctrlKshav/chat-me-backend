/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c5765eb1794bdc2fb294d31d16ad9c73)
...
declare namespace Cloudflare {
	interface Env {
		...
		SHOPIFY_API_OPTIONAL_SCOPES: string;
		SHOPIFY_APP_URL: string;
		SHOPIFY_API_VERSION: string;
		ENCRYPTION_STRING: string;
		APP_NAME: string;
		APP_HANDLE: string;
		APP_PROXY_PREFIX: string;
		APP_PROXY_SUBPATH: string;
		POS_EMBEDDED: string;
		DIRECT_API_MODE: string;
		EMBEDDED_APP_DIRECT_API_ACCESS: string;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SHOPIFY_API_KEY" | "SHOPIFY_API_SECRET" | "SHOPIFY_API_SCOPES" | "SHOPIFY_API_OPTIONAL_SCOPES" | "SHOPIFY_APP_URL" | "SHOPIFY_API_VERSION" | "ENCRYPTION_STRING" | "APP_NAME" | "APP_HANDLE" | "APP_PROXY_PREFIX" | "APP_PROXY_SUBPATH" | "POS_EMBEDDED" | "DIRECT_API_MODE" | "EMBEDDED_APP_DIRECT_API_ACCESS">> {}
}
